...
__kernel void cube(__write_only image2d_t output, __read_only ulong4 metadata, double4 frame, double4 col, ulong maxiter, double escape) {
  ...
  double4 dcol = color_darkener_o(i, maxiter, complex_mag2(val), escape, -0.1) * col;
  dcol.w = 1.0;
